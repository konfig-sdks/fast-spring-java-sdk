...
public class CreateasessionapplyingacoupontoanorderRequest {
  ...
  public CreateasessionapplyingacoupontoanorderRequest() {
  }

  public CreateasessionapplyingacoupontoanorderRequest account(String account) {
  ...
  **/
  ...
  public CreateasessionapplyingacoupontoanorderRequest items(List<Item2> items) {
  ...
  public CreateasessionapplyingacoupontoanorderRequest addItemsItem(Item2 itemsItem) {
  ...
  **/
  ...
  public CreateasessionapplyingacoupontoanorderRequest coupon(String coupon) {
  ...
  **/
   ...
   * @return the CreateasessionapplyingacoupontoanorderRequest instance itself
   */
  public CreateasessionapplyingacoupontoanorderRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateasessionapplyingacoupontoanorderRequest createasessionapplyingacoupontoanorderRequest = (CreateasessionapplyingacoupontoanorderRequest) o;
    return Objects.equals(this.account, createasessionapplyingacoupontoanorderRequest.account) &&
        Objects.equals(this.items, createasessionapplyingacoupontoanorderRequest.items) &&
        Objects.equals(this.coupon, createasessionapplyingacoupontoanorderRequest.coupon)&&
        Objects.equals(this.additionalProperties, createasessionapplyingacoupontoanorderRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(account, items, coupon, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateasessionapplyingacoupontoanorderRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateasessionapplyingacoupontoanorderRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateasessionapplyingacoupontoanorderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateasessionapplyingacoupontoanorderRequest is not found in the empty JSON string", CreateasessionapplyingacoupontoanorderRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateasessionapplyingacoupontoanorderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateasessionapplyingacoupontoanorderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateasessionapplyingacoupontoanorderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateasessionapplyingacoupontoanorderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateasessionapplyingacoupontoanorderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateasessionapplyingacoupontoanorderRequest>() {
           @Override
           public void write(JsonWriter out, CreateasessionapplyingacoupontoanorderRequest value) throws IOException {
           ...
           @Override
           public CreateasessionapplyingacoupontoanorderRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateasessionapplyingacoupontoanorderRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateasessionapplyingacoupontoanorderRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateasessionapplyingacoupontoanorderRequest
  * @throws IOException if the JSON string is invalid with respect to CreateasessionapplyingacoupontoanorderRequest
  */
  public static CreateasessionapplyingacoupontoanorderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateasessionapplyingacoupontoanorderRequest.class);
  }

 /**
  * Convert an instance of CreateasessionapplyingacoupontoanorderRequest to an JSON string
  *
  * @return JSON string
  */
