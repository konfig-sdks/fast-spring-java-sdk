...
import com.konfigthis.client.model.Pricing4;
...
public class Subscription2 {
  ...
  private Pricing4 pricing;

  public Subscription2() {
  }

  public Subscription2 subscription(String subscription) {
  ...
  **/
  ...
  public Subscription2 pricing(Pricing4 pricing) {
  ...
  **/
  ...
  public Pricing4 getPricing() {
    return pricing;
  }


  public void setPricing(Pricing4 pricing) {
   ...
   * @return the Subscription2 instance itself
   */
  public Subscription2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Subscription2 subscription2 = (Subscription2) o;
    return Objects.equals(this.subscription, subscription2.subscription) &&
        Objects.equals(this.pricing, subscription2.pricing)&&
        Objects.equals(this.additionalProperties, subscription2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subscription, pricing, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Subscription2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Subscription2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Subscription2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Subscription2 is not found in the empty JSON string", Subscription2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Subscription2.openapiRequiredFields) {
      ...
      Pricing4.validateJsonObject(jsonObj.getAsJsonObject("pricing"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Subscription2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Subscription2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Subscription2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Subscription2.class));

       return (TypeAdapter<T>) new TypeAdapter<Subscription2>() {
           @Override
           public void write(JsonWriter out, Subscription2 value) throws IOException {
           ...
           @Override
           public Subscription2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Subscription2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Subscription2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Subscription2
  * @throws IOException if the JSON string is invalid with respect to Subscription2
  */
  public static Subscription2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Subscription2.class);
  }

 /**
  * Convert an instance of Subscription2 to an JSON string
  *
  * @return JSON string
  */
