...
public class DiscountReason {
  ...
  public DiscountReason en(String en) {
  ...
  **/
  ...
  @ApiModelProperty(example = "The Reason", required = true, value = "")
   ...
   * @return the DiscountReason instance itself
   */
  public DiscountReason putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DiscountReason discountReason = (DiscountReason) o;
    return Objects.equals(this.en, discountReason.en)&&
        Objects.equals(this.additionalProperties, discountReason.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(en, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DiscountReason {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DiscountReason
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DiscountReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DiscountReason is not found in the empty JSON string", DiscountReason.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DiscountReason.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiscountReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiscountReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiscountReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiscountReason.class));

       return (TypeAdapter<T>) new TypeAdapter<DiscountReason>() {
           @Override
           public void write(JsonWriter out, DiscountReason value) throws IOException {
           ...
           @Override
           public DiscountReason read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DiscountReason instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DiscountReason given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DiscountReason
  * @throws IOException if the JSON string is invalid with respect to DiscountReason
  */
  public static DiscountReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiscountReason.class);
  }

 /**
  * Convert an instance of DiscountReason to an JSON string
  *
  * @return JSON string
  */
