...
public class SubscriptionPricing {
   ...
   * @return the SubscriptionPricing instance itself
   */
  public SubscriptionPricing putAdditionalProperty(String key, Object value) {
  ...
  public String toString() {
    ...
    sb.append("class SubscriptionPricing {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubscriptionPricing
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SubscriptionPricing.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscriptionPricing is not found in the empty JSON string", SubscriptionPricing.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscriptionPricing.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscriptionPricing' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscriptionPricing> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscriptionPricing.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscriptionPricing>() {
           @Override
           public void write(JsonWriter out, SubscriptionPricing value) throws IOException {
           ...
           @Override
           public SubscriptionPricing read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SubscriptionPricing instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SubscriptionPricing given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SubscriptionPricing
  * @throws IOException if the JSON string is invalid with respect to SubscriptionPricing
  */
  public static SubscriptionPricing fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubscriptionPricing.class);
  }

 /**
  * Convert an instance of SubscriptionPricing to an JSON string
  *
  * @return JSON string
  */
