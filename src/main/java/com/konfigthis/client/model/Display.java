...
public class Display {
  ...
  **/
   ...
   * @return the Display instance itself
   */
  public Display putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.en, display.en)&&
        Objects.equals(this.additionalProperties, display.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Display
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Display.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Display.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Display>() {
           ...
           public Display read(JsonReader in) throws IOException {
             ...
             Display instance = thisAdapter.fromJsonTree(jsonObj);
