...
public class Amount2 {
  ...
  public Amount2 USD(Integer USD) {
  ...
  **/
   ...
   * @return the Amount2 instance itself
   */
  public Amount2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.USD, amount2.USD)&&
        Objects.equals(this.additionalProperties, amount2.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Amount2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Amount2>() {
           ...
           public Amount2 read(JsonReader in) throws IOException {
             ...
             Amount2 instance = thisAdapter.fromJsonTree(jsonObj);
