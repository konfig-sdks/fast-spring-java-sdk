...
public class Discount3 {
  ...
  public Discount3 type(String type) {
  ...
  **/
  ...
  public Discount3 percentage(Integer percentage) {
  ...
  **/
  ...
  public Discount3 duration(Integer duration) {
  ...
  **/
   ...
   * @return the Discount3 instance itself
   */
  public Discount3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Discount3 discount3 = (Discount3) o;
    return Objects.equals(this.type, discount3.type) &&
        Objects.equals(this.percentage, discount3.percentage) &&
        Objects.equals(this.duration, discount3.duration)&&
        Objects.equals(this.additionalProperties, discount3.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, percentage, duration, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Discount3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Discount3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Discount3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Discount3 is not found in the empty JSON string", Discount3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Discount3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Discount3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Discount3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Discount3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Discount3.class));

       return (TypeAdapter<T>) new TypeAdapter<Discount3>() {
           @Override
           public void write(JsonWriter out, Discount3 value) throws IOException {
           ...
           @Override
           public Discount3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Discount3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Discount3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Discount3
  * @throws IOException if the JSON string is invalid with respect to Discount3
  */
  public static Discount3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Discount3.class);
  }

 /**
  * Convert an instance of Discount3 to an JSON string
  *
  * @return JSON string
  */
