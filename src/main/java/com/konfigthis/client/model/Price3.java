...
public class Price3 {
  ...
  **/
   ...
   * @return the Price3 instance itself
   */
  public Price3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Price3 price3 = (Price3) o;
    return Objects.equals(this.USD, price3.USD)&&
        Objects.equals(this.additionalProperties, price3.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Price3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Price3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Price3 is not found in the empty JSON string", Price3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Price3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Price3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Price3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Price3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Price3.class));

       return (TypeAdapter<T>) new TypeAdapter<Price3>() {
           @Override
           public void write(JsonWriter out, Price3 value) throws IOException {
           ...
           @Override
           public Price3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Price3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Price3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Price3
  * @throws IOException if the JSON string is invalid with respect to Price3
  */
  public static Price3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Price3.class);
  }

 /**
  * Convert an instance of Price3 to an JSON string
  *
  * @return JSON string
  */
