...
import com.konfigthis.client.model.Addon;
...
public class Subscription3 {
  ...
  public Subscription3 subscription(String subscription) {
  ...
  **/
  ...
  public Subscription3 addons(List<Addon> addons) {
  ...
  public Subscription3 addAddonsItem(Addon addonsItem) {
  ...
  **/
   ...
   * @return the Subscription3 instance itself
   */
  public Subscription3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Subscription3 subscription3 = (Subscription3) o;
    return Objects.equals(this.subscription, subscription3.subscription) &&
        Objects.equals(this.addons, subscription3.addons)&&
        Objects.equals(this.additionalProperties, subscription3.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Subscription3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Subscription3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Subscription3 is not found in the empty JSON string", Subscription3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Subscription3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Subscription3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Subscription3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Subscription3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Subscription3.class));

       return (TypeAdapter<T>) new TypeAdapter<Subscription3>() {
           @Override
           public void write(JsonWriter out, Subscription3 value) throws IOException {
           ...
           @Override
           public Subscription3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Subscription3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Subscription3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Subscription3
  * @throws IOException if the JSON string is invalid with respect to Subscription3
  */
  public static Subscription3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Subscription3.class);
  }

 /**
  * Convert an instance of Subscription3 to an JSON string
  *
  * @return JSON string
  */
