...
public class AddcouponcodestoacouponRequest {
  public static final String SERIALIZED_NAME_CODES = "codes";
  @SerializedName(SERIALIZED_NAME_CODES)
  private List<String> codes = new ArrayList<>();

  public AddcouponcodestoacouponRequest() {
  }

  public AddcouponcodestoacouponRequest codes(List<String> codes) {
  ...
  public AddcouponcodestoacouponRequest addCodesItem(String codesItem) {
  ...
  **/
   ...
   * @return the AddcouponcodestoacouponRequest instance itself
   */
  public AddcouponcodestoacouponRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddcouponcodestoacouponRequest addcouponcodestoacouponRequest = (AddcouponcodestoacouponRequest) o;
    return Objects.equals(this.codes, addcouponcodestoacouponRequest.codes)&&
        Objects.equals(this.additionalProperties, addcouponcodestoacouponRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddcouponcodestoacouponRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddcouponcodestoacouponRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddcouponcodestoacouponRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddcouponcodestoacouponRequest is not found in the empty JSON string", AddcouponcodestoacouponRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddcouponcodestoacouponRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddcouponcodestoacouponRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddcouponcodestoacouponRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddcouponcodestoacouponRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddcouponcodestoacouponRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddcouponcodestoacouponRequest>() {
           @Override
           public void write(JsonWriter out, AddcouponcodestoacouponRequest value) throws IOException {
           ...
           @Override
           public AddcouponcodestoacouponRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddcouponcodestoacouponRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddcouponcodestoacouponRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddcouponcodestoacouponRequest
  * @throws IOException if the JSON string is invalid with respect to AddcouponcodestoacouponRequest
  */
  public static AddcouponcodestoacouponRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddcouponcodestoacouponRequest.class);
  }

 /**
  * Convert an instance of AddcouponcodestoacouponRequest to an JSON string
  *
  * @return JSON string
  */
