...
public class Subscription5 {
  public static final String SERIALIZED_NAME_SUBSCRIPTION = "subscription";
  @SerializedName(SERIALIZED_NAME_SUBSCRIPTION)
  private String subscription;

  public static final String SERIALIZED_NAME_MANUAL_RENEW = "manualRenew";
  @SerializedName(SERIALIZED_NAME_MANUAL_RENEW)
  private String manualRenew;

  public Subscription5() {
  }

  public Subscription5 subscription(String subscription) {
  ...
  **/
  ...
  @ApiModelProperty(example = "{subscription_id}", required = true, value = "")
  ...
  public Subscription5 manualRenew(String manualRenew) {
  ...
  **/
  ...
  public String getManualRenew() {
    return manualRenew;
  }


  public void setManualRenew(String manualRenew) {
   ...
   * @return the Subscription5 instance itself
   */
  public Subscription5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Subscription5 subscription5 = (Subscription5) o;
    return Objects.equals(this.subscription, subscription5.subscription) &&
        Objects.equals(this.manualRenew, subscription5.manualRenew)&&
        Objects.equals(this.additionalProperties, subscription5.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subscription, manualRenew, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Subscription5 {\n");
    sb.append("    subscription: ").append(toIndentedString(subscription)).append("\n");
    sb.append("    manualRenew: ").append(toIndentedString(manualRenew)).append("\n");
  ...
  static {
    ...
    openapiFields.add("manualRenew");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("subscription");
    openapiRequiredFields.add("manualRenew");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Subscription5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Subscription5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Subscription5 is not found in the empty JSON string", Subscription5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Subscription5.openapiRequiredFields) {
      ...
      if (!jsonObj.get("manualRenew").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `manualRenew` to be a primitive type in the JSON string but got `%s`", jsonObj.get("manualRenew").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Subscription5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Subscription5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Subscription5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Subscription5.class));

       return (TypeAdapter<T>) new TypeAdapter<Subscription5>() {
           @Override
           public void write(JsonWriter out, Subscription5 value) throws IOException {
           ...
           @Override
           public Subscription5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Subscription5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Subscription5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Subscription5
  * @throws IOException if the JSON string is invalid with respect to Subscription5
  */
  public static Subscription5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Subscription5.class);
  }

 /**
  * Convert an instance of Subscription5 to an JSON string
  *
  * @return JSON string
  */
