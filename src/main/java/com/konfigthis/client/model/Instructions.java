...
public class Instructions {
  ...
  public Instructions en(String en) {
  ...
  **/
  ...
  public Instructions es(String es) {
  ...
  **/
   ...
   * @return the Instructions instance itself
   */
  public Instructions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.en, instructions.en) &&
        Objects.equals(this.es, instructions.es)&&
        Objects.equals(this.additionalProperties, instructions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(en, es, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Instructions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Instructions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Instructions is not found in the empty JSON string", Instructions.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Instructions.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Instructions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Instructions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Instructions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Instructions.class));

       return (TypeAdapter<T>) new TypeAdapter<Instructions>() {
           @Override
           public void write(JsonWriter out, Instructions value) throws IOException {
           ...
           @Override
           public Instructions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Instructions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Instructions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Instructions
  * @throws IOException if the JSON string is invalid with respect to Instructions
  */
  public static Instructions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Instructions.class);
  }

 /**
  * Convert an instance of Instructions to an JSON string
  *
  * @return JSON string
  */
