...
public class AddressRequest {
  ...
  public AddressRequest addressLine1(String addressLine1) {
    ...
    if (addressLine1 != null && addressLine1.length() < 0) {
      throw new IllegalArgumentException("Invalid value for addressLine1. Length must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  @ApiModelProperty(example = "801 Garden St", value = "")
  ...
  public AddressRequest addressLine2(String addressLine2) {
    ...
    if (addressLine2 != null && addressLine2.length() < 0) {
      throw new IllegalArgumentException("Invalid value for addressLine2. Length must be greater than or equal to 0.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Suite 201", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Santa Barbara", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "93101", value = "")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressLine1, addressLine2, city, country, postalCode, region, additionalProperties);
  }
