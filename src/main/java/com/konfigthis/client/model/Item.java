...
import com.konfigthis.client.model.Attributes;
import com.konfigthis.client.model.Pricing;
...
public class Item {
  ...
  **/
  ...
  @ApiModelProperty(example = "{product_id}", required = true, value = "")
  ...
  **/
  ...
  public Item pricing(Pricing pricing) {
  ...
  **/
  ...
  public Item attributes(Attributes attributes) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(product, quantity, pricing, attributes, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      Pricing.validateJsonObject(jsonObj.getAsJsonObject("pricing"));
      // validate the required field `attributes`
      Attributes.validateJsonObject(jsonObj.getAsJsonObject("attributes"));
  }
