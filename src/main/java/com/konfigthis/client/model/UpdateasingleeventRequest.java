...
public class UpdateasingleeventRequest {
  public static final String SERIALIZED_NAME_PROCESSED = "processed";
  @SerializedName(SERIALIZED_NAME_PROCESSED)
  private Boolean processed;

  public UpdateasingleeventRequest() {
  }

  public UpdateasingleeventRequest processed(Boolean processed) {
  ...
  **/
   ...
   * @return the UpdateasingleeventRequest instance itself
   */
  public UpdateasingleeventRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateasingleeventRequest updateasingleeventRequest = (UpdateasingleeventRequest) o;
    return Objects.equals(this.processed, updateasingleeventRequest.processed)&&
        Objects.equals(this.additionalProperties, updateasingleeventRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(processed, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateasingleeventRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateasingleeventRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateasingleeventRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateasingleeventRequest is not found in the empty JSON string", UpdateasingleeventRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateasingleeventRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateasingleeventRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateasingleeventRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateasingleeventRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateasingleeventRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateasingleeventRequest>() {
           @Override
           public void write(JsonWriter out, UpdateasingleeventRequest value) throws IOException {
           ...
           @Override
           public UpdateasingleeventRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateasingleeventRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateasingleeventRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateasingleeventRequest
  * @throws IOException if the JSON string is invalid with respect to UpdateasingleeventRequest
  */
  public static UpdateasingleeventRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateasingleeventRequest.class);
  }

 /**
  * Convert an instance of UpdateasingleeventRequest to an JSON string
  *
  * @return JSON string
  */
