...
public class PauseSubscriptionRequest {
  public static final String SERIALIZED_NAME_PAUSE_PERIOD_COUNT = "pausePeriodCount";
  @SerializedName(SERIALIZED_NAME_PAUSE_PERIOD_COUNT)
  private Integer pausePeriodCount;

  public PauseSubscriptionRequest() {
  }

  public PauseSubscriptionRequest pausePeriodCount(Integer pausePeriodCount) {
   ...
   /**
   * Get pausePeriodCount
   * @return pausePeriodCount
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Integer getPausePeriodCount() {
    return pausePeriodCount;
  }


  public void setPausePeriodCount(Integer pausePeriodCount) {
   ...
   * @return the PauseSubscriptionRequest instance itself
   */
  public PauseSubscriptionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pausePeriodCount, pauseSubscriptionRequest.pausePeriodCount)&&
        Objects.equals(this.additionalProperties, pauseSubscriptionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pausePeriodCount, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    pausePeriodCount: ").append(toIndentedString(pausePeriodCount)).append("\n");
  ...
  static {
    ...
    openapiFields.add("pausePeriodCount");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PauseSubscriptionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PauseSubscriptionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PauseSubscriptionRequest is not found in the empty JSON string", PauseSubscriptionRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PauseSubscriptionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PauseSubscriptionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PauseSubscriptionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PauseSubscriptionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PauseSubscriptionRequest>() {
           @Override
           public void write(JsonWriter out, PauseSubscriptionRequest value) throws IOException {
           ...
           @Override
           public PauseSubscriptionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PauseSubscriptionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PauseSubscriptionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PauseSubscriptionRequest
  * @throws IOException if the JSON string is invalid with respect to PauseSubscriptionRequest
  */
  public static PauseSubscriptionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PauseSubscriptionRequest.class);
  }

 /**
  * Convert an instance of PauseSubscriptionRequest to an JSON string
  *
  * @return JSON string
  */
