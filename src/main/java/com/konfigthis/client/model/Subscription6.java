...
public class Subscription6 {
  ...
  public Subscription6() {
  }

  public Subscription6 subscription(String subscription) {
  ...
  **/
  ...
  public Subscription6 deactivation(String deactivation) {
  ...
  **/
   ...
   * @return the Subscription6 instance itself
   */
  public Subscription6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Subscription6 subscription6 = (Subscription6) o;
    return Objects.equals(this.subscription, subscription6.subscription) &&
        Objects.equals(this.deactivation, subscription6.deactivation)&&
        Objects.equals(this.additionalProperties, subscription6.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subscription, deactivation, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Subscription6 {\n");
  ...
  static {
    ...
    openapiFields.add("deactivation");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("subscription");
    openapiRequiredFields.add("deactivation");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Subscription6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Subscription6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Subscription6 is not found in the empty JSON string", Subscription6.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Subscription6.openapiRequiredFields) {
      ...
      if (!jsonObj.get("deactivation").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `deactivation` to be a primitive type in the JSON string but got `%s`", jsonObj.get("deactivation").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Subscription6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Subscription6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Subscription6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Subscription6.class));

       return (TypeAdapter<T>) new TypeAdapter<Subscription6>() {
           @Override
           public void write(JsonWriter out, Subscription6 value) throws IOException {
           ...
           @Override
           public Subscription6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Subscription6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Subscription6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Subscription6
  * @throws IOException if the JSON string is invalid with respect to Subscription6
  */
  public static Subscription6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Subscription6.class);
  }

 /**
  * Convert an instance of Subscription6 to an JSON string
  *
  * @return JSON string
  */
