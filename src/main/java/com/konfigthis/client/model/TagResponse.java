...
public class TagResponse {
  ...
  public TagResponse key(String key) {
    
    
    if (key != null && key.length() < 0) {
      throw new IllegalArgumentException("Invalid value for key. Length must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  @ApiModelProperty(example = "tag-key", value = "")
  ...
  public TagResponse value(String value) {
    
    
    if (value != null && value.length() < 0) {
      throw new IllegalArgumentException("Invalid value for value. Length must be greater than or equal to 0.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Tag Value", value = "")
