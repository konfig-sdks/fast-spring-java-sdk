...
import com.konfigthis.client.model.Price3;
...
public class Pricing3 {
  ...
  private Price3 price;

  public Pricing3() {
  }

  public Pricing3 price(Price3 price) {
  ...
  **/
  ...
  public Price3 getPrice() {
    return price;
  }


  public void setPrice(Price3 price) {
   ...
   * @return the Pricing3 instance itself
   */
  public Pricing3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Pricing3 pricing3 = (Pricing3) o;
    return Objects.equals(this.price, pricing3.price)&&
        Objects.equals(this.additionalProperties, pricing3.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Pricing3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Pricing3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pricing3 is not found in the empty JSON string", Pricing3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Pricing3.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `price`
      Price3.validateJsonObject(jsonObj.getAsJsonObject("price"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pricing3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pricing3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pricing3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pricing3.class));

       return (TypeAdapter<T>) new TypeAdapter<Pricing3>() {
           @Override
           public void write(JsonWriter out, Pricing3 value) throws IOException {
           ...
           @Override
           public Pricing3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Pricing3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Pricing3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Pricing3
  * @throws IOException if the JSON string is invalid with respect to Pricing3
  */
  public static Pricing3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pricing3.class);
  }

 /**
  * Convert an instance of Pricing3 to an JSON string
  *
  * @return JSON string
  */
