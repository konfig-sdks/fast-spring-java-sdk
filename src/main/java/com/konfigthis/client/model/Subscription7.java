...
public class Subscription7 {
  public static final String SERIALIZED_NAME_SUBSCRIPTION = "subscription";
  @SerializedName(SERIALIZED_NAME_SUBSCRIPTION)
  private String subscription;

  public Subscription7() {
  }

  public Subscription7 subscription(String subscription) {
  ...
  **/
   ...
   * @return the Subscription7 instance itself
   */
  public Subscription7 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Subscription7 subscription7 = (Subscription7) o;
    return Objects.equals(this.subscription, subscription7.subscription)&&
        Objects.equals(this.additionalProperties, subscription7.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Subscription7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Subscription7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Subscription7 is not found in the empty JSON string", Subscription7.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Subscription7.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Subscription7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Subscription7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Subscription7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Subscription7.class));

       return (TypeAdapter<T>) new TypeAdapter<Subscription7>() {
           @Override
           public void write(JsonWriter out, Subscription7 value) throws IOException {
           ...
           @Override
           public Subscription7 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Subscription7 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Subscription7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Subscription7
  * @throws IOException if the JSON string is invalid with respect to Subscription7
  */
  public static Subscription7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Subscription7.class);
  }

 /**
  * Convert an instance of Subscription7 to an JSON string
  *
  * @return JSON string
  */
