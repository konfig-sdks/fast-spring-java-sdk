...
public class ItemTaxResponse {
  ...
  public static final String SERIALIZED_NAME_TOTAL_TAXABLE = "totalTaxable";
  @SerializedName(SERIALIZED_NAME_TOTAL_TAXABLE)
  private Double totalTaxable;

  public ItemTaxResponse() {
  }

  public ItemTaxResponse taxValue(Double taxValue) {
  ...
  public ItemTaxResponse taxValue(Integer taxValue) {
    
    
    
    
    this.taxValue = taxValue.doubleValue();
    return this;
  }
  ...
  **/
  ...
  public ItemTaxResponse totalTaxable(Double totalTaxable) {
  ...
  public ItemTaxResponse totalTaxable(Integer totalTaxable) {
    
    
    
    
    this.totalTaxable = totalTaxable.doubleValue();
    return this;
  }
  ...
  **/
   ...
   * @return the ItemTaxResponse instance itself
   */
  public ItemTaxResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ItemTaxResponse itemTaxResponse = (ItemTaxResponse) o;
    return Objects.equals(this.taxValue, itemTaxResponse.taxValue) &&
        Objects.equals(this.totalTaxable, itemTaxResponse.totalTaxable)&&
        Objects.equals(this.additionalProperties, itemTaxResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taxValue, totalTaxable, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ItemTaxResponse {\n");
    sb.append("    taxValue: ").append(toIndentedString(taxValue)).append("\n");
    sb.append("    totalTaxable: ").append(toIndentedString(totalTaxable)).append("\n");
  ...
  static {
    ...
    openapiFields.add("totalTaxable");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ItemTaxResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ItemTaxResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemTaxResponse is not found in the empty JSON string", ItemTaxResponse.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemTaxResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemTaxResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemTaxResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemTaxResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemTaxResponse>() {
           @Override
           public void write(JsonWriter out, ItemTaxResponse value) throws IOException {
           ...
           @Override
           public ItemTaxResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ItemTaxResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ItemTaxResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ItemTaxResponse
  * @throws IOException if the JSON string is invalid with respect to ItemTaxResponse
  */
  public static ItemTaxResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemTaxResponse.class);
  }

 /**
  * Convert an instance of ItemTaxResponse to an JSON string
  *
  * @return JSON string
  */
