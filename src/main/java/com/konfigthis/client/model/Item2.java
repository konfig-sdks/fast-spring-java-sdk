...
public class Item2 {
  ...
  public Item2 product(String product) {
  ...
  **/
   ...
   * @return the Item2 instance itself
   */
  public Item2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Item2 item2 = (Item2) o;
    return Objects.equals(this.product, item2.product) &&
        Objects.equals(this.quantity, item2.quantity)&&
        Objects.equals(this.additionalProperties, item2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Item2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Item2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Item2>() {
           ...
           public Item2 read(JsonReader in) throws IOException {
             ...
             Item2 instance = thisAdapter.fromJsonTree(jsonObj);
