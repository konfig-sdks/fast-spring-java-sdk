...
public class UpdateordertagsandattributesRequest {
  public static final String SERIALIZED_NAME_ORDERS = "orders";
  @SerializedName(SERIALIZED_NAME_ORDERS)
  private List<Order> orders = new ArrayList<>();

  public UpdateordertagsandattributesRequest() {
  }

  public UpdateordertagsandattributesRequest orders(List<Order> orders) {
  ...
  public UpdateordertagsandattributesRequest addOrdersItem(Order ordersItem) {
  ...
  **/
   ...
   * @return the UpdateordertagsandattributesRequest instance itself
   */
  public UpdateordertagsandattributesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateordertagsandattributesRequest updateordertagsandattributesRequest = (UpdateordertagsandattributesRequest) o;
    return Objects.equals(this.orders, updateordertagsandattributesRequest.orders)&&
        Objects.equals(this.additionalProperties, updateordertagsandattributesRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateordertagsandattributesRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateordertagsandattributesRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateordertagsandattributesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateordertagsandattributesRequest is not found in the empty JSON string", UpdateordertagsandattributesRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateordertagsandattributesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateordertagsandattributesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateordertagsandattributesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateordertagsandattributesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateordertagsandattributesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateordertagsandattributesRequest>() {
           @Override
           public void write(JsonWriter out, UpdateordertagsandattributesRequest value) throws IOException {
           ...
           @Override
           public UpdateordertagsandattributesRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateordertagsandattributesRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateordertagsandattributesRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateordertagsandattributesRequest
  * @throws IOException if the JSON string is invalid with respect to UpdateordertagsandattributesRequest
  */
  public static UpdateordertagsandattributesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateordertagsandattributesRequest.class);
  }

 /**
  * Convert an instance of UpdateordertagsandattributesRequest to an JSON string
  *
  * @return JSON string
  */
