...
public class StoreEntitlement {
  ...
  public StoreEntitlement() {
  }

  public StoreEntitlement siteId(String siteId) {
  ...
  **/
  ...
  public StoreEntitlement roles(List<String> roles) {
  ...
  public StoreEntitlement addRolesItem(String rolesItem) {
    if (this.roles == null) {
  ...
  **/
   ...
   * @return the StoreEntitlement instance itself
   */
  public StoreEntitlement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    StoreEntitlement storeEntitlement = (StoreEntitlement) o;
    return Objects.equals(this.siteId, storeEntitlement.siteId) &&
        Objects.equals(this.roles, storeEntitlement.roles)&&
        Objects.equals(this.additionalProperties, storeEntitlement.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(siteId, roles, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StoreEntitlement {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to StoreEntitlement
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StoreEntitlement.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StoreEntitlement is not found in the empty JSON string", StoreEntitlement.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StoreEntitlement.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StoreEntitlement' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StoreEntitlement> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StoreEntitlement.class));

       return (TypeAdapter<T>) new TypeAdapter<StoreEntitlement>() {
           @Override
           public void write(JsonWriter out, StoreEntitlement value) throws IOException {
           ...
           @Override
           public StoreEntitlement read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             StoreEntitlement instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of StoreEntitlement given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StoreEntitlement
  * @throws IOException if the JSON string is invalid with respect to StoreEntitlement
  */
  public static StoreEntitlement fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StoreEntitlement.class);
  }

 /**
  * Convert an instance of StoreEntitlement to an JSON string
  *
  * @return JSON string
  */
