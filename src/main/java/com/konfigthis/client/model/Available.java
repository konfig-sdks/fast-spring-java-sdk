...
public class Available {
  ...
  public Available start(String start) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2019-12-01", required = true, value = "")
  ...
  public Available end(String end) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2019-12-31", required = true, value = "")
   ...
   * @return the Available instance itself
   */
  public Available putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.start, available.start) &&
        Objects.equals(this.end, available.end)&&
        Objects.equals(this.additionalProperties, available.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Available
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Available.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Available is not found in the empty JSON string", Available.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Available.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Available.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Available' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Available> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Available.class));

       return (TypeAdapter<T>) new TypeAdapter<Available>() {
           @Override
           public void write(JsonWriter out, Available value) throws IOException {
           ...
           @Override
           public Available read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Available instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Available given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Available
  * @throws IOException if the JSON string is invalid with respect to Available
  */
  public static Available fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Available.class);
  }

 /**
  * Convert an instance of Available to an JSON string
  *
  * @return JSON string
  */
