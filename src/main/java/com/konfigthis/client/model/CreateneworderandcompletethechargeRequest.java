...
public class CreateneworderandcompletethechargeRequest {
  ...
  public CreateneworderandcompletethechargeRequest() {
  }

  public CreateneworderandcompletethechargeRequest tags(Tags tags) {
  ...
  **/
  ...
  public CreateneworderandcompletethechargeRequest account(String account) {
  ...
  **/
  ...
  public CreateneworderandcompletethechargeRequest coupon(String coupon) {
  ...
  **/
  ...
  public CreateneworderandcompletethechargeRequest currency(String currency) {
  ...
  **/
  ...
  public CreateneworderandcompletethechargeRequest items(List<Item> items) {
  ...
  public CreateneworderandcompletethechargeRequest addItemsItem(Item itemsItem) {
  ...
  **/
   ...
   * @return the CreateneworderandcompletethechargeRequest instance itself
   */
  public CreateneworderandcompletethechargeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateneworderandcompletethechargeRequest createneworderandcompletethechargeRequest = (CreateneworderandcompletethechargeRequest) o;
    return Objects.equals(this.tags, createneworderandcompletethechargeRequest.tags) &&
        Objects.equals(this.account, createneworderandcompletethechargeRequest.account) &&
        Objects.equals(this.coupon, createneworderandcompletethechargeRequest.coupon) &&
        Objects.equals(this.currency, createneworderandcompletethechargeRequest.currency) &&
        Objects.equals(this.items, createneworderandcompletethechargeRequest.items)&&
        Objects.equals(this.additionalProperties, createneworderandcompletethechargeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, account, coupon, currency, items, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateneworderandcompletethechargeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateneworderandcompletethechargeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateneworderandcompletethechargeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateneworderandcompletethechargeRequest is not found in the empty JSON string", CreateneworderandcompletethechargeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateneworderandcompletethechargeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateneworderandcompletethechargeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateneworderandcompletethechargeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateneworderandcompletethechargeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateneworderandcompletethechargeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateneworderandcompletethechargeRequest>() {
           @Override
           public void write(JsonWriter out, CreateneworderandcompletethechargeRequest value) throws IOException {
           ...
           @Override
           public CreateneworderandcompletethechargeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateneworderandcompletethechargeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateneworderandcompletethechargeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateneworderandcompletethechargeRequest
  * @throws IOException if the JSON string is invalid with respect to CreateneworderandcompletethechargeRequest
  */
  public static CreateneworderandcompletethechargeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateneworderandcompletethechargeRequest.class);
  }

 /**
  * Convert an instance of CreateneworderandcompletethechargeRequest to an JSON string
  *
  * @return JSON string
  */
