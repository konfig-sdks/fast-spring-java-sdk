...
import com.konfigthis.client.model.Lookup;
...
public class UpdateexistingaccountRequest {
  ...
  public UpdateexistingaccountRequest() {
  }

  public UpdateexistingaccountRequest contact(Contact contact) {
  ...
  **/
  ...
  public UpdateexistingaccountRequest language(String language) {
  ...
  **/
  ...
  public UpdateexistingaccountRequest country(String country) {
  ...
  **/
  ...
  public UpdateexistingaccountRequest lookup(Lookup lookup) {
  ...
  **/
   ...
   * @return the UpdateexistingaccountRequest instance itself
   */
  public UpdateexistingaccountRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateexistingaccountRequest updateexistingaccountRequest = (UpdateexistingaccountRequest) o;
    return Objects.equals(this.contact, updateexistingaccountRequest.contact) &&
        Objects.equals(this.language, updateexistingaccountRequest.language) &&
        Objects.equals(this.country, updateexistingaccountRequest.country) &&
        Objects.equals(this.lookup, updateexistingaccountRequest.lookup)&&
        Objects.equals(this.additionalProperties, updateexistingaccountRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contact, language, country, lookup, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateexistingaccountRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("lookup");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateexistingaccountRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateexistingaccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateexistingaccountRequest is not found in the empty JSON string", UpdateexistingaccountRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateexistingaccountRequest.openapiRequiredFields) {
      ...
      // validate the required field `lookup`
      Lookup.validateJsonObject(jsonObj.getAsJsonObject("lookup"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateexistingaccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateexistingaccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateexistingaccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateexistingaccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateexistingaccountRequest>() {
           @Override
           public void write(JsonWriter out, UpdateexistingaccountRequest value) throws IOException {
           ...
           @Override
           public UpdateexistingaccountRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateexistingaccountRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateexistingaccountRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateexistingaccountRequest
  * @throws IOException if the JSON string is invalid with respect to UpdateexistingaccountRequest
  */
  public static UpdateexistingaccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateexistingaccountRequest.class);
  }

 /**
  * Convert an instance of UpdateexistingaccountRequest to an JSON string
  *
  * @return JSON string
  */
