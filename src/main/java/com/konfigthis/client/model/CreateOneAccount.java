...
public class CreateOneAccount {
  ...
  public CreateOneAccount contact(ContactRequest contact) {
  ...
  **/
   ...
   * @return the CreateOneAccount instance itself
   */
  public CreateOneAccount putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateOneAccount createOneAccount = (CreateOneAccount) o;
    return Objects.equals(this.contact, createOneAccount.contact)&&
        Objects.equals(this.additionalProperties, createOneAccount.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateOneAccount {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateOneAccount
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateOneAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOneAccount is not found in the empty JSON string", CreateOneAccount.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOneAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOneAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOneAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOneAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOneAccount>() {
           @Override
           public void write(JsonWriter out, CreateOneAccount value) throws IOException {
           ...
           @Override
           public CreateOneAccount read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateOneAccount instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateOneAccount given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateOneAccount
  * @throws IOException if the JSON string is invalid with respect to CreateOneAccount
  */
  public static CreateOneAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOneAccount.class);
  }

 /**
  * Convert an instance of CreateOneAccount to an JSON string
  *
  * @return JSON string
  */
