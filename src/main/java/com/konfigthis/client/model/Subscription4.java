...
import com.konfigthis.client.model.Addon1;
...
public class Subscription4 {
  ...
  private List<Addon1> addons = new ArrayList<>();

  public Subscription4() {
  }

  public Subscription4 subscription(String subscription) {
  ...
  **/
  ...
  public Subscription4 addons(List<Addon1> addons) {
  ...
  public Subscription4 addAddonsItem(Addon1 addonsItem) {
  ...
  **/
   ...
   * @return the Subscription4 instance itself
   */
  public Subscription4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Subscription4 subscription4 = (Subscription4) o;
    return Objects.equals(this.subscription, subscription4.subscription) &&
        Objects.equals(this.addons, subscription4.addons)&&
        Objects.equals(this.additionalProperties, subscription4.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subscription, addons, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Subscription4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Subscription4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Subscription4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Subscription4 is not found in the empty JSON string", Subscription4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Subscription4.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayaddons.size(); i++) {
        Addon1.validateJsonObject(jsonArrayaddons.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Subscription4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Subscription4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Subscription4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Subscription4.class));

       return (TypeAdapter<T>) new TypeAdapter<Subscription4>() {
           @Override
           public void write(JsonWriter out, Subscription4 value) throws IOException {
           ...
           @Override
           public Subscription4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Subscription4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Subscription4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Subscription4
  * @throws IOException if the JSON string is invalid with respect to Subscription4
  */
  public static Subscription4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Subscription4.class);
  }

 /**
  * Convert an instance of Subscription4 to an JSON string
  *
  * @return JSON string
  */
