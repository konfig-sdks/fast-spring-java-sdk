...
import com.konfigthis.client.model.Discount2;
...
public class Pricing4 {
  ...
  private Discount2 discount;

  public Pricing4() {
  }

  public Pricing4 price(Price4 price) {
  ...
  **/
  ...
  public Pricing4 discount(Discount2 discount) {
  ...
  **/
  ...
  public void setDiscount(Discount2 discount) {
   ...
   * @return the Pricing4 instance itself
   */
  public Pricing4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Pricing4 pricing4 = (Pricing4) o;
    return Objects.equals(this.price, pricing4.price) &&
        Objects.equals(this.discount, pricing4.discount)&&
        Objects.equals(this.additionalProperties, pricing4.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Pricing4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Pricing4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pricing4 is not found in the empty JSON string", Pricing4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Pricing4.openapiRequiredFields) {
      ...
      Discount2.validateJsonObject(jsonObj.getAsJsonObject("discount"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pricing4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pricing4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pricing4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pricing4.class));

       return (TypeAdapter<T>) new TypeAdapter<Pricing4>() {
           @Override
           public void write(JsonWriter out, Pricing4 value) throws IOException {
           ...
           @Override
           public Pricing4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Pricing4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Pricing4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Pricing4
  * @throws IOException if the JSON string is invalid with respect to Pricing4
  */
  public static Pricing4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pricing4.class);
  }

 /**
  * Convert an instance of Pricing4 to an JSON string
  *
  * @return JSON string
  */
