...
public class Attributes1 {
  public static final String SERIALIZED_NAME_ATTRIBUTE_KEY1 = "AttributeKey1";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTE_KEY1)
  private String attributeKey1;

  public static final String SERIALIZED_NAME_ATTRIBUTE_KEY2 = "AttributeKey2";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTE_KEY2)
  private String attributeKey2;

  public Attributes1() {
  }

  public Attributes1 attributeKey1(String attributeKey1) {
  ...
  **/
  ...
  @ApiModelProperty(example = "AttributeValue1", required = true, value = "")
  ...
  public Attributes1 attributeKey2(String attributeKey2) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "AttributeValue2", required = true, value = "")
   ...
   * @return the Attributes1 instance itself
   */
  public Attributes1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributeKey1, attributes1.attributeKey1) &&
        Objects.equals(this.attributeKey2, attributes1.attributeKey2)&&
        Objects.equals(this.additionalProperties, attributes1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributeKey1, attributeKey2, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    attributeKey1: ").append(toIndentedString(attributeKey1)).append("\n");
    sb.append("    attributeKey2: ").append(toIndentedString(attributeKey2)).append("\n");
  ...
  static {
    ...
    openapiFields.add("AttributeKey1");
    openapiFields.add("AttributeKey2");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("AttributeKey1");
    openapiRequiredFields.add("AttributeKey2");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Attributes1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Attributes1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (!jsonObj.get("AttributeKey1").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `AttributeKey1` to be a primitive type in the JSON string but got `%s`", jsonObj.get("AttributeKey1").toString()));
      }
      if (!jsonObj.get("AttributeKey2").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `AttributeKey2` to be a primitive type in the JSON string but got `%s`", jsonObj.get("AttributeKey2").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Attributes1>() {
           ...
           public Attributes1 read(JsonReader in) throws IOException {
             ...
             Attributes1 instance = thisAdapter.fromJsonTree(jsonObj);
