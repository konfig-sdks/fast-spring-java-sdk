...
import com.konfigthis.client.model.Pricing3;
...
public class Item3 {
  ...
  private Pricing3 pricing;

  public Item3() {
  }

  public Item3 product(String product) {
  ...
  **/
  ...
  public Item3 pricing(Pricing3 pricing) {
  ...
  **/
  ...
  public Pricing3 getPricing() {
    return pricing;
  }


  public void setPricing(Pricing3 pricing) {
   ...
   * @return the Item3 instance itself
   */
  public Item3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Item3 item3 = (Item3) o;
    return Objects.equals(this.product, item3.product) &&
        Objects.equals(this.quantity, item3.quantity) &&
        Objects.equals(this.pricing, item3.pricing)&&
        Objects.equals(this.additionalProperties, item3.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(product, quantity, pricing, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Item3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Item3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      Pricing3.validateJsonObject(jsonObj.getAsJsonObject("pricing"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Item3>() {
           ...
           public Item3 read(JsonReader in) throws IOException {
             ...
             Item3 instance = thisAdapter.fromJsonTree(jsonObj);
