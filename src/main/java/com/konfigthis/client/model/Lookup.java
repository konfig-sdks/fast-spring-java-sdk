...
public class Lookup {
  ...
  public Lookup custom(String custom) {
  ...
  **/
  ...
  @ApiModelProperty(example = "customKey", required = true, value = "")
   ...
   * @return the Lookup instance itself
   */
  public Lookup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.custom, lookup.custom)&&
        Objects.equals(this.additionalProperties, lookup.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(custom, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Lookup
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Lookup.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Lookup.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("custom").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Lookup>() {
           ...
           public Lookup read(JsonReader in) throws IOException {
             ...
             Lookup instance = thisAdapter.fromJsonTree(jsonObj);
