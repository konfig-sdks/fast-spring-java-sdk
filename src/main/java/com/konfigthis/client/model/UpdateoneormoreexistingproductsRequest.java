...
public class UpdateoneormoreexistingproductsRequest {
  public static final String SERIALIZED_NAME_PRODUCTS = "products";
  @SerializedName(SERIALIZED_NAME_PRODUCTS)
  private List<Product> products = new ArrayList<>();

  public UpdateoneormoreexistingproductsRequest() {
  }

  public UpdateoneormoreexistingproductsRequest products(List<Product> products) {
  ...
  public UpdateoneormoreexistingproductsRequest addProductsItem(Product productsItem) {
  ...
  **/
   ...
   * @return the UpdateoneormoreexistingproductsRequest instance itself
   */
  public UpdateoneormoreexistingproductsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateoneormoreexistingproductsRequest updateoneormoreexistingproductsRequest = (UpdateoneormoreexistingproductsRequest) o;
    return Objects.equals(this.products, updateoneormoreexistingproductsRequest.products)&&
        Objects.equals(this.additionalProperties, updateoneormoreexistingproductsRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateoneormoreexistingproductsRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateoneormoreexistingproductsRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateoneormoreexistingproductsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateoneormoreexistingproductsRequest is not found in the empty JSON string", UpdateoneormoreexistingproductsRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateoneormoreexistingproductsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateoneormoreexistingproductsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateoneormoreexistingproductsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateoneormoreexistingproductsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateoneormoreexistingproductsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateoneormoreexistingproductsRequest>() {
           @Override
           public void write(JsonWriter out, UpdateoneormoreexistingproductsRequest value) throws IOException {
           ...
           @Override
           public UpdateoneormoreexistingproductsRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateoneormoreexistingproductsRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateoneormoreexistingproductsRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateoneormoreexistingproductsRequest
  * @throws IOException if the JSON string is invalid with respect to UpdateoneormoreexistingproductsRequest
  */
  public static UpdateoneormoreexistingproductsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateoneormoreexistingproductsRequest.class);
  }

 /**
  * Convert an instance of UpdateoneormoreexistingproductsRequest to an JSON string
  *
  * @return JSON string
  */
