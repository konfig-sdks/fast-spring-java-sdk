...
public class Addon1 {
  ...
  public Addon1 product(String product) {
  ...
  **/
  ...
  @ApiModelProperty(example = "{subscription_addon_path}", required = true, value = "")
  ...
  public Addon1 quantity(Integer quantity) {
  ...
  **/
   ...
   * @return the Addon1 instance itself
   */
  public Addon1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Addon1 addon1 = (Addon1) o;
    return Objects.equals(this.product, addon1.product) &&
        Objects.equals(this.quantity, addon1.quantity)&&
        Objects.equals(this.additionalProperties, addon1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(product, quantity, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Addon1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Addon1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Addon1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Addon1 is not found in the empty JSON string", Addon1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Addon1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Addon1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Addon1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Addon1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Addon1.class));

       return (TypeAdapter<T>) new TypeAdapter<Addon1>() {
           @Override
           public void write(JsonWriter out, Addon1 value) throws IOException {
           ...
           @Override
           public Addon1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Addon1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Addon1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Addon1
  * @throws IOException if the JSON string is invalid with respect to Addon1
  */
  public static Addon1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Addon1.class);
  }

 /**
  * Convert an instance of Addon1 to an JSON string
  *
  * @return JSON string
  */
