...
public class CreateoneormorenewproductsRequest {
  public static final String SERIALIZED_NAME_PRODUCTS = "products";
  @SerializedName(SERIALIZED_NAME_PRODUCTS)
  private List<Product> products = new ArrayList<>();

  public CreateoneormorenewproductsRequest() {
  }

  public CreateoneormorenewproductsRequest products(List<Product> products) {
  ...
  public CreateoneormorenewproductsRequest addProductsItem(Product productsItem) {
  ...
  **/
   ...
   * @return the CreateoneormorenewproductsRequest instance itself
   */
  public CreateoneormorenewproductsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateoneormorenewproductsRequest createoneormorenewproductsRequest = (CreateoneormorenewproductsRequest) o;
    return Objects.equals(this.products, createoneormorenewproductsRequest.products)&&
        Objects.equals(this.additionalProperties, createoneormorenewproductsRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateoneormorenewproductsRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateoneormorenewproductsRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateoneormorenewproductsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateoneormorenewproductsRequest is not found in the empty JSON string", CreateoneormorenewproductsRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateoneormorenewproductsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateoneormorenewproductsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateoneormorenewproductsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateoneormorenewproductsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateoneormorenewproductsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateoneormorenewproductsRequest>() {
           @Override
           public void write(JsonWriter out, CreateoneormorenewproductsRequest value) throws IOException {
           ...
           @Override
           public CreateoneormorenewproductsRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateoneormorenewproductsRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateoneormorenewproductsRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateoneormorenewproductsRequest
  * @throws IOException if the JSON string is invalid with respect to CreateoneormorenewproductsRequest
  */
  public static CreateoneormorenewproductsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateoneormorenewproductsRequest.class);
  }

 /**
  * Convert an instance of CreateoneormorenewproductsRequest to an JSON string
  *
  * @return JSON string
  */
