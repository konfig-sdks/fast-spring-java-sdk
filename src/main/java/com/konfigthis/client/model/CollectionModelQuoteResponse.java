...
public class CollectionModelQuoteResponse {
  ...
  private List<QuoteResponse> content = null;

  public CollectionModelQuoteResponse() {
  }

  public CollectionModelQuoteResponse links(List<Link> links) {
  ...
  public CollectionModelQuoteResponse addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public CollectionModelQuoteResponse content(List<QuoteResponse> content) {
  ...
  public CollectionModelQuoteResponse addContentItem(QuoteResponse contentItem) {
  ...
  **/
  ...
  public List<QuoteResponse> getContent() {
    return content;
  }


  public void setContent(List<QuoteResponse> content) {
   ...
   * @return the CollectionModelQuoteResponse instance itself
   */
  public CollectionModelQuoteResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CollectionModelQuoteResponse collectionModelQuoteResponse = (CollectionModelQuoteResponse) o;
    return Objects.equals(this.links, collectionModelQuoteResponse.links) &&
        Objects.equals(this.content, collectionModelQuoteResponse.content)&&
        Objects.equals(this.additionalProperties, collectionModelQuoteResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, content, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CollectionModelQuoteResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CollectionModelQuoteResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CollectionModelQuoteResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollectionModelQuoteResponse is not found in the empty JSON string", CollectionModelQuoteResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            QuoteResponse.validateJsonObject(jsonArraycontent.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CollectionModelQuoteResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CollectionModelQuoteResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CollectionModelQuoteResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CollectionModelQuoteResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CollectionModelQuoteResponse>() {
           @Override
           public void write(JsonWriter out, CollectionModelQuoteResponse value) throws IOException {
           ...
           @Override
           public CollectionModelQuoteResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CollectionModelQuoteResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CollectionModelQuoteResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CollectionModelQuoteResponse
  * @throws IOException if the JSON string is invalid with respect to CollectionModelQuoteResponse
  */
  public static CollectionModelQuoteResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CollectionModelQuoteResponse.class);
  }

 /**
  * Convert an instance of CollectionModelQuoteResponse to an JSON string
  *
  * @return JSON string
  */
