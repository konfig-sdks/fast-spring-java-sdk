...
public class AddressResponse {
  ...
  **/
   ...
   * @return the AddressResponse instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addressLine1, addressResponse.addressLine1) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddressResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddressResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AddressResponse>() {
           ...
           public AddressResponse read(JsonReader in) throws IOException {
             ...
             AddressResponse instance = thisAdapter.fromJsonTree(jsonObj);
