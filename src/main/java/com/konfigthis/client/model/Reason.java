...
public class Reason {
  ...
  **/
  ...
  @ApiModelProperty(example = "Your Reason", required = true, value = "")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Your Reason in German", required = true, value = "")
   ...
   * @return the Reason instance itself
   */
  public Reason putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.en, reason.en) &&
        Objects.equals(this.de, reason.de)&&
        Objects.equals(this.additionalProperties, reason.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(en, de, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Reason.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (!jsonObj.get("de").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Reason>() {
           ...
           public Reason read(JsonReader in) throws IOException {
             ...
             Reason instance = thisAdapter.fromJsonTree(jsonObj);
