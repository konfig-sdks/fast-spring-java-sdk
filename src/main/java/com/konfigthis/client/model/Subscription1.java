...
public class Subscription1 {
  ...
  public Subscription1 subscription(String subscription) {
  ...
  **/
  ...
  public Subscription1 next(String next) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2019-01-30", required = true, value = "")
  ...
  public Subscription1 end(Integer end) {
  ...
  **/
  ...
  public Subscription1 quantity(Integer quantity) {
  ...
  **/
  ...
  public Subscription1 coupons(List<String> coupons) {
  ...
  public Subscription1 addCouponsItem(String couponsItem) {
  ...
  **/
   ...
   * @return the Subscription1 instance itself
   */
  public Subscription1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.subscription, subscription1.subscription) &&
        Objects.equals(this.next, subscription1.next) &&
        Objects.equals(this.end, subscription1.end) &&
        Objects.equals(this.quantity, subscription1.quantity) &&
        Objects.equals(this.coupons, subscription1.coupons)&&
        Objects.equals(this.additionalProperties, subscription1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subscription, next, end, quantity, coupons, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Subscription1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Subscription1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Subscription1.openapiRequiredFields) {
      ...
      if (jsonObj.get("coupons") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("coupons").isJsonArray()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Subscription1>() {
           ...
           public Subscription1 read(JsonReader in) throws IOException {
             ...
             Subscription1 instance = thisAdapter.fromJsonTree(jsonObj);
