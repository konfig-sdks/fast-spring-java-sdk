...
import com.konfigthis.client.model.Amount2;
...
public class Discount2 {
  ...
  public Discount2 type(String type) {
  ...
  **/
  ...
  @ApiModelProperty(example = "amount", required = true, value = "")
  ...
  public Discount2 amount(Amount2 amount) {
  ...
  **/
  ...
  public Discount2 duration(String duration) {
  ...
  **/
   ...
   * @return the Discount2 instance itself
   */
  public Discount2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Discount2 discount2 = (Discount2) o;
    return Objects.equals(this.type, discount2.type) &&
        Objects.equals(this.amount, discount2.amount) &&
        Objects.equals(this.duration, discount2.duration)&&
        Objects.equals(this.additionalProperties, discount2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, amount, duration, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Discount2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Discount2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Discount2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Discount2 is not found in the empty JSON string", Discount2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Discount2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Discount2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Discount2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Discount2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Discount2.class));

       return (TypeAdapter<T>) new TypeAdapter<Discount2>() {
           @Override
           public void write(JsonWriter out, Discount2 value) throws IOException {
           ...
           @Override
           public Discount2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Discount2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Discount2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Discount2
  * @throws IOException if the JSON string is invalid with respect to Discount2
  */
  public static Discount2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Discount2.class);
  }

 /**
  * Convert an instance of Discount2 to an JSON string
  *
  * @return JSON string
  */
