...
public class Attributes2 {
  ...
  public Attributes2 key1(String key1) {
  ...
  **/
  ...
  public Attributes2 key2(String key2) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "value2", required = true, value = "")
   ...
   * @return the Attributes2 instance itself
   */
  public Attributes2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key1, attributes2.key1) &&
        Objects.equals(this.key2, attributes2.key2)&&
        Objects.equals(this.additionalProperties, attributes2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Attributes2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Attributes2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Attributes2.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("key1").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("key2").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Attributes2>() {
           ...
           public Attributes2 read(JsonReader in) throws IOException {
             ...
             Attributes2 instance = thisAdapter.fromJsonTree(jsonObj);
