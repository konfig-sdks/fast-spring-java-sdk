...
public class CreateanaccountRequest {
  ...
  public CreateanaccountRequest contact(Contact contact) {
  ...
  **/
  ...
  public CreateanaccountRequest language(String language) {
  ...
  **/
  ...
  public CreateanaccountRequest country(String country) {
  ...
  **/
  ...
  public CreateanaccountRequest lookup(Lookup lookup) {
  ...
  **/
   ...
   * @return the CreateanaccountRequest instance itself
   */
  public CreateanaccountRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateanaccountRequest createanaccountRequest = (CreateanaccountRequest) o;
    return Objects.equals(this.contact, createanaccountRequest.contact) &&
        Objects.equals(this.language, createanaccountRequest.language) &&
        Objects.equals(this.country, createanaccountRequest.country) &&
        Objects.equals(this.lookup, createanaccountRequest.lookup)&&
        Objects.equals(this.additionalProperties, createanaccountRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateanaccountRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateanaccountRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateanaccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateanaccountRequest is not found in the empty JSON string", CreateanaccountRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateanaccountRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateanaccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateanaccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateanaccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateanaccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateanaccountRequest>() {
           @Override
           public void write(JsonWriter out, CreateanaccountRequest value) throws IOException {
           ...
           @Override
           public CreateanaccountRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateanaccountRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateanaccountRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateanaccountRequest
  * @throws IOException if the JSON string is invalid with respect to CreateanaccountRequest
  */
  public static CreateanaccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateanaccountRequest.class);
  }

 /**
  * Convert an instance of CreateanaccountRequest to an JSON string
  *
  * @return JSON string
  */
