...
public class Tags {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Tags tags = (Tags) o;
    return Objects.equals(this.tag1, tags.tag1)&&
        Objects.equals(this.additionalProperties, tags.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tag1, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("tag1");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("tag1");
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("tag1").isJsonPrimitive()) {
