...
import com.konfigthis.client.model.Discount3;
import com.konfigthis.client.model.Price4;
...
public class Pricing5 {
  ...
  private Discount3 discount;

  public Pricing5() {
  }

  public Pricing5 price(Price4 price) {
  ...
  **/
  ...
  public Pricing5 discount(Discount3 discount) {
  ...
  **/
  ...
  public Discount3 getDiscount() {
    return discount;
  }


  public void setDiscount(Discount3 discount) {
   ...
   * @return the Pricing5 instance itself
   */
  public Pricing5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Pricing5 pricing5 = (Pricing5) o;
    return Objects.equals(this.price, pricing5.price) &&
        Objects.equals(this.discount, pricing5.discount)&&
        Objects.equals(this.additionalProperties, pricing5.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(price, discount, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Pricing5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Pricing5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Pricing5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pricing5 is not found in the empty JSON string", Pricing5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Pricing5.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `price`
      Price4.validateJsonObject(jsonObj.getAsJsonObject("price"));
      // validate the required field `discount`
      Discount3.validateJsonObject(jsonObj.getAsJsonObject("discount"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pricing5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pricing5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pricing5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pricing5.class));

       return (TypeAdapter<T>) new TypeAdapter<Pricing5>() {
           @Override
           public void write(JsonWriter out, Pricing5 value) throws IOException {
           ...
           @Override
           public Pricing5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Pricing5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Pricing5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Pricing5
  * @throws IOException if the JSON string is invalid with respect to Pricing5
  */
  public static Pricing5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pricing5.class);
  }

 /**
  * Convert an instance of Pricing5 to an JSON string
  *
  * @return JSON string
  */
