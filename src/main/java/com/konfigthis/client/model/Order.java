...
import com.konfigthis.client.model.Tags1;
...
public class Order {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "{order_id}", required = true, value = "")
  ...
  public Order items(List<Item1> items) {
  ...
  public Order addItemsItem(Item1 itemsItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, order, items, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      Tags1.validateJsonObject(jsonObj.getAsJsonObject("tags"));
