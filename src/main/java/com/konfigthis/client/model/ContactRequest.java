...
public class ContactRequest {
  ...
  public ContactRequest company(String company) {
    ...
    if (company != null && company.length() < 0) {
      throw new IllegalArgumentException("Invalid value for company. Length must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  @ApiModelProperty(example = "ne1@all.com", required = true, value = "")
  ...
  public ContactRequest first(String first) {
    
    
    if (first != null && first.length() < 0) {
      throw new IllegalArgumentException("Invalid value for first. Length must be greater than or equal to 0.");
    }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Leeroy", required = true, value = "")
  ...
  public ContactRequest last(String last) {
    
    
    if (last != null && last.length() < 0) {
      throw new IllegalArgumentException("Invalid value for last. Length must be greater than or equal to 0.");
    }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Jenkins", required = true, value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "+1254789654", value = "")
   ...
   * @return the ContactRequest instance itself
   */
  public ContactRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.company, contactRequest.company) &&
        Objects.equals(this.email, contactRequest.email) &&
        Objects.equals(this.first, contactRequest.first) &&
        Objects.equals(this.last, contactRequest.last) &&
        Objects.equals(this.phone, contactRequest.phone)&&
        Objects.equals(this.additionalProperties, contactRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(company, email, first, last, phone, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContactRequest>() {
           ...
           public ContactRequest read(JsonReader in) throws IOException {
             ...
             ContactRequest instance = thisAdapter.fromJsonTree(jsonObj);
