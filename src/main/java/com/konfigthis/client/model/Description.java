...
import com.konfigthis.client.model.Full;
import com.konfigthis.client.model.Summary;
...
public class Description {
  ...
  public Description summary(Summary summary) {
  ...
  **/
  ...
  public Description action(Action action) {
  ...
  **/
  ...
  public Description full(Full full) {
  ...
  **/
   ...
   * @return the Description instance itself
   */
  public Description putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.summary, description.summary) &&
        Objects.equals(this.action, description.action) &&
        Objects.equals(this.full, description.full)&&
        Objects.equals(this.additionalProperties, description.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(summary, action, full, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Description.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Description.openapiRequiredFields) {
      ...
      // validate the required field `full`
      Full.validateJsonObject(jsonObj.getAsJsonObject("full"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Description>() {
           ...
           public Description read(JsonReader in) throws IOException {
             ...
             Description instance = thisAdapter.fromJsonTree(jsonObj);
