...
public class Full {
  ...
  **/
   ...
   * @return the Full instance itself
   */
  public Full putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Full full = (Full) o;
    return Objects.equals(this.en, full.en)&&
        Objects.equals(this.additionalProperties, full.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Full
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Full.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Full is not found in the empty JSON string", Full.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Full.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Full.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Full' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Full> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Full.class));

       return (TypeAdapter<T>) new TypeAdapter<Full>() {
           @Override
           public void write(JsonWriter out, Full value) throws IOException {
           ...
           @Override
           public Full read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Full instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Full given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Full
  * @throws IOException if the JSON string is invalid with respect to Full
  */
  public static Full fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Full.class);
  }

 /**
  * Convert an instance of Full to an JSON string
  *
  * @return JSON string
  */
