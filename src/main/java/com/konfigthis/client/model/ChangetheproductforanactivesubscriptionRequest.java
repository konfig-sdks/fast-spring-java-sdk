...
public class ChangetheproductforanactivesubscriptionRequest {
  public static final String SERIALIZED_NAME_SUBSCRIPTIONS = "subscriptions";
  @SerializedName(SERIALIZED_NAME_SUBSCRIPTIONS)
  private List<Subscription> subscriptions = new ArrayList<>();

  public ChangetheproductforanactivesubscriptionRequest() {
  }

  public ChangetheproductforanactivesubscriptionRequest subscriptions(List<Subscription> subscriptions) {
  ...
  public ChangetheproductforanactivesubscriptionRequest addSubscriptionsItem(Subscription subscriptionsItem) {
  ...
  **/
   ...
   * @return the ChangetheproductforanactivesubscriptionRequest instance itself
   */
  public ChangetheproductforanactivesubscriptionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ChangetheproductforanactivesubscriptionRequest changetheproductforanactivesubscriptionRequest = (ChangetheproductforanactivesubscriptionRequest) o;
    return Objects.equals(this.subscriptions, changetheproductforanactivesubscriptionRequest.subscriptions)&&
        Objects.equals(this.additionalProperties, changetheproductforanactivesubscriptionRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChangetheproductforanactivesubscriptionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChangetheproductforanactivesubscriptionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ChangetheproductforanactivesubscriptionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangetheproductforanactivesubscriptionRequest is not found in the empty JSON string", ChangetheproductforanactivesubscriptionRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChangetheproductforanactivesubscriptionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangetheproductforanactivesubscriptionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangetheproductforanactivesubscriptionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangetheproductforanactivesubscriptionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangetheproductforanactivesubscriptionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangetheproductforanactivesubscriptionRequest>() {
           @Override
           public void write(JsonWriter out, ChangetheproductforanactivesubscriptionRequest value) throws IOException {
           ...
           @Override
           public ChangetheproductforanactivesubscriptionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ChangetheproductforanactivesubscriptionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ChangetheproductforanactivesubscriptionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChangetheproductforanactivesubscriptionRequest
  * @throws IOException if the JSON string is invalid with respect to ChangetheproductforanactivesubscriptionRequest
  */
  public static ChangetheproductforanactivesubscriptionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangetheproductforanactivesubscriptionRequest.class);
  }

 /**
  * Convert an instance of ChangetheproductforanactivesubscriptionRequest to an JSON string
  *
  * @return JSON string
  */
