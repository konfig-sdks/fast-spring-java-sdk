...
public class ReturnsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ReturnsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ReturnsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createNewReturnCall(Object body, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createNewReturnValidateBeforeCall(Object body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling createNewReturn(Async)");
        }

        return createNewReturnCall(body, _callback);

    }


    private ApiResponse<Object> createNewReturnWithHttpInfo(Object body) throws ApiException {
        okhttp3.Call localVarCall = createNewReturnValidateBeforeCall(body, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewReturnAsync(Object body, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewReturnValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class CreateNewReturnRequestBuilder {
        private Object body;

        private CreateNewReturnRequestBuilder() {
        }

        /**
         * Set body
         * @param body  (optional)
         * @return CreateNewReturnRequestBuilder
         */
        public CreateNewReturnRequestBuilder body(Object body) {
            this.body = body;
            return this;
        }

        /**
         * Build call for createNewReturn
        ...
        /**
         * Execute createNewReturn request
         * @return Object
        ...
        public Object execute() throws ApiException {
            Object body = buildBodyParams();
            ApiResponse<Object> localVarResp = createNewReturnWithHttpInfo(body);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewReturn request with HTTP info returned
        ...
        public ApiResponse<Object> executeWithHttpInfo() throws ApiException {
            Object body = buildBodyParams();
            return createNewReturnWithHttpInfo(body);
        }

        /**
         * Execute createNewReturn request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Object> _callback) throws ApiException {
            Object body = buildBodyParams();
            return createNewReturnAsync(body, _callback);
        }
    }
     ...
     */
    public CreateNewReturnRequestBuilder createNewReturn() throws IllegalArgumentException {
        return new CreateNewReturnRequestBuilder();
    }
    private okhttp3.Call getByIdCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/returns/{id}"
    ...
    private ApiResponse<Object> getByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByIdAsync(String id, final ApiCallback<Object> _callback) throws ApiException {
    ...
    public class GetByIdRequestBuilder {
         ...
         */
        public Object execute() throws ApiException {
            ApiResponse<Object> localVarResp = getByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
