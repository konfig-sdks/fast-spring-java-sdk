...
/**
 * Model tests for CreateQuoteRequest
 */
public class CreateQuoteRequestTest {
    private final CreateQuoteRequest model = new CreateQuoteRequest();
