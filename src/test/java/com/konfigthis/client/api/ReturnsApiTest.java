...
public class ReturnsApiTest {
    ...
    private static ReturnsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ReturnsApi(apiClient);
    }
     ...
     */
    @Test
    public void createNewReturnTest() throws ApiException {
        Object response = api.createNewReturn()
                .execute();
    ...
    public void getByIdTest() throws ApiException {
        String id = null;
        Object response = api.getById(id)
                .execute();
        // TODO: test validations
    }
