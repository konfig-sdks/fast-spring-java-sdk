...
public class SubscriptionsApiTest {
     ...
     */
    @Test
    public void cancelSubscriptionByIdTest() throws ApiException {
        String subscriptionId = null;
        Object response = api.cancelSubscriptionById(subscriptionId)
                .execute();
     ...
     */
    @Test
    public void convertExpiredTrialWithoutPaymentMethodTest() throws ApiException {
        String subscriptionId = null;
        Object response = api.convertExpiredTrialWithoutPaymentMethod(subscriptionId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllSubscriptionsTest() throws ApiException {
        Object response = api.getAllSubscriptions()
                .execute();
        // TODO: test validations
    }
    ...
    public void getByIdTest() throws ApiException {
        ...
        String scope = null;
        String status = null;
        Object response = api.getById(subscriptionId)
                .accountId(accountId)
                .begin(begin)
                .end(end)
                .event(event)
     ...
     */
    @Test
    public void getPlanChangeHistoryTest() throws ApiException {
        String subscriptionId = null;
        String scope = null;
        String order = null;
        api.getPlanChangeHistory(subscriptionId)
                .scope(scope)
                .order(order)
                .execute();
        // TODO: test validations
    ...
    public void pauseSubscriptionTest() throws ApiException {
        String subscriptionId = null;
        Integer pausePeriodCount = null;
        Object response = api.pauseSubscription(subscriptionId)
     ...
     */
    @Test
    public void previewPlanChangeTest() throws ApiException {
        String subscription = null;
        String product = null;
        Integer quantity = null;
        Price pricing = null;
        List<SubscriptionAddon> addons = null;
        Object response = api.previewPlanChange(subscription)
                .product(product)
                .quantity(quantity)
                .pricing(pricing)
                .addons(addons)
     ...
     */
    @Test
    public void rebillManagedSubscriptionTest() throws ApiException {
        Object response = api.rebillManagedSubscription()
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void removeScheduledPauseTest() throws ApiException {
        String subscriptionId = null;
        Object response = api.removeScheduledPause(subscriptionId)
                .execute();
        // TODO: test validations
    }
    ...
    public void resumeSubscriptionTest() throws ApiException {
        List<Subscription6> subscriptions = null;
        String subscriptionId = null;
        api.resumeSubscription(subscriptions, subscriptionId)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateSubscriptionTest() throws ApiException {
        ...
        Object response = api.updateSubscription(subscriptions)
                .execute();
        // TODO: test validations
    }
