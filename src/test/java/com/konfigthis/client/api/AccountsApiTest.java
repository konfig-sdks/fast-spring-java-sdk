...
public class AccountsApiTest {
    ...
    public void getAccountByIdTest() throws ApiException {
        ...
        Object response = api.getAccountById(accountId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getAuthenticatedManagementUrlTest() throws ApiException {
        String accountId = null;
        Object response = api.getAuthenticatedManagementUrl(accountId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getByParameterTest() throws ApiException {
        String email = null;
        String custom = null;
        String global = null;
        String orderID = null;
        ...
        Double limit = null;
        Double page = null;
        Object response = api.getByParameter()
                .email(email)
                .custom(custom)
                .global(global)
                .orderID(orderID)
    ...
    public void updateAccountByIdTest() throws ApiException {
        String accountId = null;
        ContactRequest contact = null;
        Object response = api.updateAccountById(accountId)
                .contact(contact)
                .execute();
        // TODO: test validations
    }
