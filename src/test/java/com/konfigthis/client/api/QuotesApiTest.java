...
public class QuotesApiTest {
    ...
    private static QuotesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new QuotesApi(apiClient);
    }
     ...
     */
    @Test
    public void cancelQuoteByIdTest() throws ApiException {
        String id = null;
        QuoteResponse response = api.cancelQuoteById(id)
                .execute();
     ...
     */
    @Test
    public void createNewQuoteTest() throws ApiException {
        List<ItemRequest> items = null;
        String name = null;
        AddressRequest recipientAddress = null;
        ContactRequest recipient = null;
        List<TagRequest> tags = null;
        String coupon = null;
        String currency = null;
        Integer expirationDateDays = null;
        String fulfillmentTerm = null;
        String notes = null;
        Integer netTermsDays = null;
        String taxId = null;
        String source = null;
        String sourceIP = null;
        QuoteResponse response = api.createNewQuote(items, name, recipientAddress, recipient)
                .tags(tags)
                .coupon(coupon)
                .currency(currency)
     ...
     */
    @Test
    public void deleteQuoteByIdTest() throws ApiException {
        String id = null;
        QuoteResponse response = api.deleteQuoteById(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getAllQuotesTest() throws ApiException {
        OffsetDateTime createdBegin = null;
        OffsetDateTime createdEnd = null;
        String createdEmail = null;
        OffsetDateTime expiresBegin = null;
        OffsetDateTime expiresEnd = null;
        String searchParam = null;
        OffsetDateTime expiredBefore = null;
        Boolean onlyQuoteId = null;
        List<String> statuses = null;
        CollectionModelQuoteResponse response = api.getAllQuotes()
    ...
    public void getByIdTest() throws ApiException {
        String id = null;
        QuoteResponse response = api.getById(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateQuoteByIdTest() throws ApiException {
        String id = null;
        UpdateQuoteRequest updateQuoteRequest = null;
        QuoteResponse response = api.updateQuoteById(id)
