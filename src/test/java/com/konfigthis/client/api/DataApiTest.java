...
public class DataApiTest {
     ...
     */
    @Test
    public void downloadReportByIdTest() throws ApiException {
        String id = null;
        String response = api.downloadReportById(id)
                .execute();
     ...
     */
    @Test
    public void generateRevenueReportTest() throws ApiException {
        FilterRevenueReportRequest filter = null;
        List<String> reportColumns = null;
        List<String> groupBy = null;
        Integer pageCount = null;
        Integer pageNumber = null;
        Boolean async = null;
        List<String> notificationEmails = null;
        Object response = api.generateRevenueReport()
                .filter(filter)
     ...
     */
    @Test
    public void generateSubscriptionReportTest() throws ApiException {
        FilterSubscriptionReportRequest filter = null;
        List<String> reportColumns = null;
        List<String> groupBy = null;
        Integer pageCount = null;
        Integer pageNumber = null;
        Boolean async = null;
        List<String> notificationEmails = null;
        Object response = api.generateSubscriptionReport()
                .filter(filter)
                .reportColumns(reportColumns)
                .groupBy(groupBy)
                .pageCount(pageCount)
    ...
    public void getJobInformationTest() throws ApiException {
        String id = null;
        Object response = api.getJobInformation(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getJobInformation_0Test() throws ApiException {
        Object response = api.getJobInformation_0()
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void resetCacheForServiceEndPointsTest() throws ApiException {
        String response = api.resetCacheForServiceEndPoints()
                .execute();
        // TODO: test validations
    }
