...
public class CouponsApiTest {
    ...
    private static CouponsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new CouponsApi(apiClient);
    }
     ...
     */
    @Test
    public void assignCodesToCouponTest() throws ApiException {
        List<String> codes = null;
        String couponId = null;
        api.assignCodesToCoupon(codes, couponId)
                .execute();
     ...
     */
    @Test
    public void createNewCouponTest() throws ApiException {
        api.createNewCoupon()
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void deleteAssociatedCodesTest() throws ApiException {
        String couponId = null;
        api.deleteAssociatedCodes(couponId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getCodesAssignedToCouponTest() throws ApiException {
        String couponId = null;
        Object response = api.getCodesAssignedToCoupon(couponId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getDetailsTest() throws ApiException {
        String couponId = null;
        Object response = api.getDetails(couponId)
                .execute();
        // TODO: test validations
    }
