...
public class OrdersApiTest {
    ...
    public void getByDateRangeTest() throws ApiException {
        ...
        Double limit = null;
        Double page = null;
        Object response = api.getByDateRange(beginDate, endDate, limit, page)
                .execute();
     ...
     */
    @Test
    public void getByEndDateTest() throws ApiException {
        String endDate = null;
        Object response = api.getByEndDate(endDate)
                .execute();
        // TODO: test validations
    }
    ...
    public void getByIdTest() throws ApiException {
        String orderId = null;
        Object response = api.getById(orderId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getByProductPathTest() throws ApiException {
        ...
        Double limit = null;
        Double page = null;
        Object response = api.getByProductPath(productPath, limit, page)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getByProductPathAndDateRangeTest() throws ApiException {
        String productPath = null;
        String beginDate = null;
        String endDate = null;
        Double limit = null;
        Double page = null;
        Object response = api.getByProductPathAndDateRange(productPath, beginDate, endDate)
                .limit(limit)
                .page(page)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void getOrdersWithReturnsTest() throws ApiException {
        String beginDate = null;
        String endDate = null;
        Boolean _return = null;
        Object response = api.getOrdersWithReturns(beginDate, endDate, _return)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateTagsAndAttributesTest() throws ApiException {
        Object response = api.updateTagsAndAttributes()
                .execute();
        // TODO: test validations
    }
